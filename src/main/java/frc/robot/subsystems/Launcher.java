...
public class Launcher extends SubsystemBase {
  ...
  public Launcher() {
    ...
    indexRight = new CANSparkMax(2, MotorType.kBrushless);
    indexRight.follow(indexLeft);
    indexRight.setInverted(true);

    feedController = new CANSparkMax(3, MotorType.kBrushless);

    launcherLeft = new CANSparkMax(4, MotorType.kBrushless);
    launcherRight = new CANSparkMax(5, MotorType.kBrushless);
